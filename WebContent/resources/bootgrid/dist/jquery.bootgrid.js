    ...
    */
    ...
    function loadData()
    {
        ...
        if (this.options.ajax)
        {
            ...
            request = $.extend(true,this.options.getSearchVal(), request);
    ...
    function renderSearchField()
    {
        if (this.options.navigation !== 0)
        {
            ...
            if (searchItems.length > 0)
            {
                ...
                search.on("click" + namespace, search, function (e)
                {
                    e.preventDefault();
                    e.stopPropagation();
                    that.current = 1;
    ...
    Grid.defaults = {
        ...
        getSearchVal : function(){return {};}, // get query object
        ...
        templates: {
            ...
            search: "<div class=\"{{css.search}}\"><button class=\"navbar-minimalize btn btn-primary\"><i class=\"fa fa-search\"></i>&nbsp;&nbsp;搜索</button></div>",
